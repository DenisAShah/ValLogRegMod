...
labels = {'tum_res': 'Residual tumor at postchemotherapy resection',
 ...
 'lnldhst': 'log(LDH/upper limit of local normal value)'
}
...
```{python, tab1_bis, warning=FALSE, message=FALSE}
