...
<details>
  <summary>Click to expand code</summary>
```{python, moder_cal, fig.align='center',echo=TRUE, eval=FALSE, warning=FALSE, message=FALSE, fig.width=5, fig.height=5}
## Fitting the logistic regression model ------------------
y = rdata["tum_res"]
X_rdata = rdata[["ter_pos_Yes", "preafp_Yes", "prehcg_Yes", "sqpost", "reduc10"]]
X_rdata = X_rdata.assign(intercept = 1.0)
...
```{python, moder_cal, fig.align='center', warning=FALSE, eval=TRUE, fig.width=5, fig.height=5}
```
