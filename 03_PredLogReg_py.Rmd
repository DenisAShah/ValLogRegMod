...
Discrimination slope was 0.30 (95% CI: 0.27-0.32), and 0.24 (95% CI: 0.17-0.29) for the development and validation data, respectively. Internal cross-validation based on optimism-corrected bootstrapping showed a discrimination slope of 0.29.
...
res_mean_cal = pd.DataFrame(res_mean_cal, 
                         ...
                         index = ["Calibration intercept", "Discrimination slope"])
```
