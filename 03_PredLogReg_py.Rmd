...
res_discr = np.reshape(
  (round(cstat_rdata, 2),
   round(np.percentile(cstat_dev_b, q = 2.5), 2),
   round(np.percentile(cstat_dev_b, q = 97.5), 2), 
   
   round(np.float64(res_int["C-statistic"]), 2),
   None,
   None,
   
   round(cstat_vdata, 2),
   round(np.percentile(cstat_val_b, q = 2.5), 2),
   round(np.percentile(cstat_val_b, q = 97.5), 2),
   
   round(dslope_rdata, 2),
   round(np.percentile(dslope_dev_b, q = 2.5), 2),
   round(np.percentile(dslope_dev_b, q = 97.5), 2),
   
   round(np.float64(res_int["Discrimination slope"]), 2),
   None,
   None,
   
   round(dslope_vdata, 2),
   round(np.percentile(dslope_val_b, q = 2.5), 2),
   round(np.percentile(dslope_val_b, q = 97.5), 2)),
