...
Different level of calibration can be estimated: mean, weak, and moderate calibration.
...
<details>
  <summary>Click to expand code</summary>
```{r, overall, warning=FALSE, message=FALSE, eval=FALSE}
